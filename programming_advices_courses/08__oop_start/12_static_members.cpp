/*
    Static variables inside function; like static x; 
        - When function scope is ended/finshed every variable and object will be destroyed;
            -   Unless (باستثناء) it was static; the static lifetime is (Project lifetime).
        ...
        - We need variable shared to all object of specific class;
            - Like global variable only at class level على مستوى الكلاس
