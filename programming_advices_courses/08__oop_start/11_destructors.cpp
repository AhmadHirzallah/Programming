/*
    ...
    -   When we have object (person of cls_person) and it is in memory and inside function call;
     then when we end the function call and get out of the scope of the main we will destroy (destructe) objects of classes also!
    ...
    -   We only can have (one destructer) inside the class and NO OVERLOADING and NO PARAMETERS or return PARAMETERS !
*/
